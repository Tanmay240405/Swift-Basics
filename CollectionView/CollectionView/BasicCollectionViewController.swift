//
//  BasicCollectionViewControlerCollectionViewController.swift
//  CollectionView
//
...
//        self.collectionView!.register(UICollectionViewCell.self, forCellWithReuseIdentifier: reuseIdentifier)
    ...
    private func generateLayout() -> UICollectionViewCompositionalLayout {
        ...
        let groupSize = NSCollectionLayoutSize(widthDimension: .fractionalWidth(0.9), heightDimension: .absolute(70.0))
